...
function(tina_add_desktop_frontend target)
    cmake_parse_arguments(PARSE_ARGV 1 ARG "INSTALL" "CONTENT" "SOURCES;LINK")
    if(NOT ARG_SOURCES OR NOT ARG_CONTENT)
        message(FATAL_ERROR
            "tina_add_desktop_frontend(${target}) requires SOURCES and CONTENT.")
    endif()
...
function(tina_add_web_frontend target)
    cmake_parse_arguments(PARSE_ARGV 1 ARG "" "CONTENT;SHELL" "SOURCES;LINK")
    if(NOT ARG_SOURCES OR NOT ARG_CONTENT)
        message(FATAL_ERROR
...
#
# Asset loading is a second, independent gap: TargetPlatform has no Android value
# (AssetFormat.hpp), and nothing in the tree calls AAssetManager, so cooked assets cannot
# be produced for or read on a device yet. Content that reads no assets -- the gallery is
# the worked example -- runs regardless.
