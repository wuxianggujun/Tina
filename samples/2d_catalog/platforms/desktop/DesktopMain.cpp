...
int main(int argc, char** argv)
{
    ...
    // The catalog stays beside the executable rather than being deleted here: the next run
    // wipes it before cooking, and leaving it makes the cook inspectable after a crash.
    {
