...
//   - That text is appended to assets/world_assets.recipe (atlas + tileset + tiles),
...
// Must match the hex ids written into assets/world_assets.recipe.
...
{
    auto assetsPath = Tina::Core::applicationFilePath("assets/world_assets.recipe");
    if (!assetsPath)
    {
