...
M7-B1 私有 WindowSurface handoff、M7-B2 Desktop bootstrap + 真实 GPU 冒烟，以及 M7-C1b/M7-C1c-a
standalone Retained Tree/Flex-lite layout/committed hit snapshot foundation：私有
...
三份 snapshot。当前仍没有 point hit-test、反向顺序目标选择、Capture -> Target -> Bubble 路由、Focus/Capture/
