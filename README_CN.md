...
M10-A2c～A2q 同步 Catalog/Cooked 闭环；M10-A3～A10 Handle/Lease、AssetSystem、有界 IO Task、
Desktop BoundedTask、Null UploadTicket、ReadyCpu→ReadyGpu，以及 `tina_sample_asset` 产品 smoke。
仍不包含 CPU TaskGroup、bgfx 真实 GPU 资源/fence 或 Cooker。
