...
static_assert(std::is_standard_layout_v<Tina::Render::Mesh3DPointLightShadow>);
static_assert(Tina::Render::Mesh3DPointLightShadow::FaceCount == 6U);
static_assert(Tina::Render::Mesh3DPointLightShadow{}.nearPlaneMeters == 0.05F);
static_assert(Tina::Render::Mesh3DPointLightShadow::MaximumDepthBias == 0.05F);
static_assert(Tina::Render::Mesh3DPointLightShadow::MaximumNormalBiasMeters == 1.0F);
