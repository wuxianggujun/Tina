...
TEST(UIBehaviorStateStorageTests, PublishesCapabilitiesAtomicallyAndReusesReleasedSlots)
{
    ...
    UI::Detail::UIBehaviorStateStorage storage(3, 1, 1, 1, resource);
...
{
    std::pmr::monotonic_buffer_resource resource;
    UI::Detail::UIBehaviorStateStorage storage(2, 1, 0, 0, resource);
...
{
    std::pmr::monotonic_buffer_resource resource;
    UI::Detail::UIBehaviorStateStorage storage(2, 1, 1, 0, resource);
