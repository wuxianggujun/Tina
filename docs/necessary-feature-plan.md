...
固定单 SpotLight shadow、deterministic pass scheduler、Cook-Torrance GGX direct light 与 cooked
EnvironmentMap split-sum IBL；point shadow、可配置 atlas、skin/animation 仍未完成。
