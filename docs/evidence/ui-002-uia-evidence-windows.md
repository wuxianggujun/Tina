...
> 标题等于 `Tina UI Showcase - Complete Retained Controls`，而
> `samples/ui_showcase/platforms/desktop/DesktopMain.cpp:567`（复核当日路径为
> `samples/ui_showcase/main.cpp:573`，示例目录此后已按脚手架重组）已把
