...
| RENDER-001 | Partial | P2 | PBR Material、lighting 与 pass scheduling | **已完成** experimental MR + factors + baseColor/MR/normal 贴图 bind（normal 用导数 TBN，无 mesh tangents）；sample_3d 接线。**待** multi-light/IBL/shadow、pass scheduling、vertex tangents |
