...
| UI-003 | Partial | P1 | 建立跨 DPI/GPU 容差视觉门禁 | 稳定门禁机 | **已完成** ContentScale* 映射单测 + 单机 ROI 视觉门禁（`RunUi003VisualGate.ps1`，白帧排除、settings/progress/playfield ROI）；**待** 真机 100/150/200% 多 DPI 截图矩阵与字体 fingerprint 金标 | Unit + Visual |
