...
out\build\windows-msvc-vnext\bin\Debug\tina_assetc.exe --out <catalogRoot> --recipe <pack.recipe>
...
# Optional vNext miniaudio adapter (null backend hermetic tests; M11-A9/A10):
...
cmake --build --preset windows-vnext-release --target tina_asset_tests
