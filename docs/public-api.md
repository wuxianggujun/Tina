...
| `CookedAssetFile` / `loadCookedAssetFile` / `loadCookedAssetFromCatalog` | M10-A2c 契约 | Asset module public | owning Cooked object bytes + 校验；Catalog 根路径解析 | NotFound / Io / ContentHashMismatch / Catalog 对齐失败；失败不发布 |
