...
| `tina_sample_2d` | M10-A32–A36 已实现 | sample (GLFW+bgfx[+Physics2D][+FreeType]) | 正式 2D 产品 executable；Catalog TileMap + character + UI/Text + optional crate | sample JSON `sample=tina_sample_2d` |
