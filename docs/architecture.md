...
| vNext M10-A32 Catalog TileMap bgfx sample | 已完成可见烟测 | `tina_sample_2d_tilemap_bgfx`：cook/load Texture2D+Tileset+TileMap，atlas 上传，emit 11 tile + 角色。无 UI/Box2D 产品门禁 |
