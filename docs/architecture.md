...
| vNext M11-A4 Physics2D single-thread bench | 已完成 Release 基线工具 | `tina_physics2d_bench` stack_dynamic step p50/p95/p99 JSON；非 ADR-0018 完整 schema。Tile adapter 与正式2D产品接线后置 |
