...
| vNext M11-A1 Physics2D contact events | 已完成直接门禁 | step 前复制 begin/end/hit 到固定 Tina storage；destroy tombstone；通道 overflow；`contactEvents()` borrowed view。Query、deferred command、benchmark、Tile adapter 与正式2D产品接线后置 |
