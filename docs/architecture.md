...
| vNext M11-A2 Physics2D spatial query | 已完成直接门禁 | `overlapAabb` 精确 overlap、`castRay`/`castRayClosest`、caller buffer overflow、稳定排序。deferred command、benchmark、Tile adapter 与正式2D产品接线后置 |
