...
| vNext M10-A34 TileMap sample Physics2D | 已完成可选门禁 | `windows-msvc-vnext-bgfx-physics2d`：Tile static sync + dynamic crate contact/sprite。无中文 FreeType Label 产品门禁 |
