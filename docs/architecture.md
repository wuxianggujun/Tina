...
- `TinaEditor.exe`（target `tina_editor_desktop`）：独立 `Tina::EditorApp` 的 World2D/World3D/TileMap canonical
  document、独立 path/baseline/dirty workspace session、TRS Inspector、viewport gizmo、Tile brush/layer/cook preview、
