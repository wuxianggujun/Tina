...
- product-3d schema 13：2份 P3N3T4UV2 tangent mesh upload、cooked EnvironmentMap upload/IBL bind/clear/retire=`1/1/1/1`、固定4级联 CSM config authored/submitted=`1`、固定 SpotLight shadow authored/submitted=`1/1`、实时 logical/framebuffer extent、相机 aspect 匹配与 responsive UI authoring，继承
...
| PBR/其他纹理通道 | Partial | metallic-roughness/normal、Cook-Torrance GGX、cooked EnvironmentMap split-sum IBL、固定4级联 CSM 与固定单 SpotLight shadow 已进 Material/Render 产品门禁；emissive/occlusion 等扩展通道、point shadow 与可配置 atlas 后置 |
