...
| 3D | multi-mesh/multi-prim SPLIT cook、Resources-owned AssetStore、Prefab/Scene weak Mesh/Material Handle、engine-provided/State-owned fixed-capacity Mesh3D registry、packet-local geometry/material ref、Mesh/Material/共享 Texture 统一 owner、原子 material bundle、baseColor/MR/normal 采样、material factors、World DirectionalLight3D/PointLight3D→逐帧 RenderScene snapshot、PointLight3D influence-sphere frustum culling、实时 framebuffer camera aspect、responsive product UI、URI 安全、Texture/Mesh retirement marker | 完整 PBR/IBL/shadow、spot light + culling、通用 pass system |
