...
| AssetHandle 终态 | 2D World Sprite 已存 weak Handle + borrowed resolver；3D mesh/material、FX/TileMap 与产品 binding registry 仍用 key | A1 已完成；总项仍 Partial，Handle/FrameResourceRef 终态后置 |
