...
| UI 扩展 | 可组合标准 Behavior、bounded Component、node-local StyleSheet、Image/Icon/NineSlice 与 paint-only Motion | [0023](adr/0023-ui-extensibility-style-paint-motion.md) | Partial：首个 UI benchmark protocol、UI-IMAGE-001 A/B/C 与 UI-COMPONENT-001 已落地；Style/Motion 继续按垂直切片实现 |
