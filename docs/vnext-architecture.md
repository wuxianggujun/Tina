...
- Physics：Box2D 2D 产品路径已有；Jolt 5.5.0 Physics3D 的 rigid body/Character/contact/floating-origin 由产品拥有的 `Gameplay3D::Scene3DRuntime` 接到 Prefab v5 Scene World。EngineHost 不拥有 Physics、Scene 或 Asset；joint、compound/mesh、CCD、移动平台速度和性能预算仍后置。
