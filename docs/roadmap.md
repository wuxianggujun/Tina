...
近期 UI：焦点 KeyDown/KeyUp 路由、Button 键盘 pressed 生命周期、方向键空间导航和 Modal Focus Scope 已完成首轮；下一步补手柄映射、可访问语义和截图回归。Clip/ScrollView、ListView 虚拟化、Style/Theme、DPI 与 Windows IME composition 已完成首轮。
