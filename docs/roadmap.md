...
| UI-STYLE-001 | InProgress；强类型 StyleClass、ColorToken registry/value、运行期 reverse-dependency 更新、node-local pseudo-state 与预编译有界 stylesheet 已落地，待 Image tint/opacity 等属性面与 Visual 门禁 |
