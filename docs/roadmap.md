...
| UI-FLOW-001 | InProgress；固定容量 Layer/Screen 栈、Pause Back Action Router、单用户输入设备提示已接入 2D 产品，后续推进多本地用户与更宽 action 集 |
...
UI-FLOW-001 InProgress
  ...
  -> multi-local-user routing / wider product actions pending
