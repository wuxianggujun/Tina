...
| TEST-003 | bgfx + FreeType 图同轮运行 Core/Scene/Asset/Render/UI 模块测试和 300 帧 product-3d；当前 schema 6 同时验证 glTF/PBR、3个 directional light、PointLight3D authored/committed/culled=`3/2/1` 与稳定提交、Mesh/Material/共享 Texture owner retirement、packet-local resolver、Asset ListView/Scene TreeView 与 Dark→Light→Dark retained UI |
...
| 3D product | 双 mesh + Resources-owned AssetSystem + Prefab/Scene weak mesh/material Handle + engine-provided、State-owned Mesh3D registry + packet-local geometry/material resolver、Mesh/Material/共享 Texture 统一 owner、原子 material bundle、baseColor/MR/normal 贴图采样、material factors、World DirectionalLight3D/PointLight3D→逐帧 RenderScene snapshot 与 point-light sphere-frustum culling 已有证据；schema 6 证明3个 directional light、PointLight3D authored/committed/culled=`3/2/1` 连续300帧稳定提交，并保留2 Mesh/2 Material/3 Texture handoff、weak handle 失效、ledger Released、成熟 retained controls、Asset ListView/Scene TreeView 与 Dark→Light→Dark | RENDER-001 的完整 PBR/IBL/shadow、spot light + culling、pass scheduling、vertex tangents |
