...
| `tina_sample_2d` | M10-A32–A37 正式 2D 产品样例 | Catalog TileMap + Character + UI/Text/Button；可选 Physics crate / FreeType；脚本化行走撞墙；product-2d `productGate=bgfx-physics-freetype` | 合成 pointer 点击 non-penetration、生产 cooker 全量后置 |
