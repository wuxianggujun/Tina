...
| `tina_sample_2d` | M10-A32–A36 正式 2D 产品样例命名门禁 | 同 `2d_tilemap_bgfx` 源；Catalog TileMap + Character + UI/Text；可选 Physics crate / FreeType；product-2d 图 `productGate=bgfx-physics-freetype` | pointer non-penetration、生产 cooker 全量后置 |
