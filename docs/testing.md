...
| `tina_sample_2d_tilemap_bgfx` | M10-A32/A33 Catalog→GPU 可见 TileMap + UI overlay | cook/load Texture2D+Tileset+TileMap，atlas 上传，emit 11 tile + 角色，2 HUD panel；JSON 门禁 | 无 Box2D/中文 FreeType 正式产品门禁 |
