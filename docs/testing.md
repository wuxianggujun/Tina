...
| `tina_sample_2d_tilemap_bgfx` | M10-A32–A35 Catalog→GPU TileMap + UI/Text + 可选 Physics/FreeType | cook/load Texture2D+Tileset+TileMap，11 tile + 角色 + 可选 crate，2 HUD panel + 2 Label；physics/freetype 图分项 JSON | 正式 `tina_sample_2d` 命名/input 产品门禁后置 |
