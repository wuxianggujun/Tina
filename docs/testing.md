...
| `tina_sample_3d` | M11-E3–E5 最小产品竖切已实现 | Catalog recipe → StaticMesh + Unlit Material（可选 Texture2D）→ GPU mesh/texture bind → 3 instance + UI；300 帧 JSON 与资源账本 | **尚未** glTF/Prefab/PBR；不单独满足 M12 Legacy 删除 |
