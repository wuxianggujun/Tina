...
| Windows 11 / MSVC 19.50 / CMake 4.2.3 | M10-A2h catalog validate CLI | Debug/Release C++23 | CLI smoke | `tina_catalog_validate --help` 与缺失 root 失败 JSON；与 `tina_asset_tests` 37/37 同图。不实现 Handle/Lease |
