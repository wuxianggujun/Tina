...
| `tina_sample_2d_tilemap_bgfx` | M10-A32–A34 Catalog→GPU TileMap + UI + 可选 Physics2D | cook/load Texture2D+Tileset+TileMap，atlas 上传，11 tile + 角色 + 可选 crate，2 HUD panel；physics 图校验 contact | 无中文 FreeType 正式产品门禁 |
