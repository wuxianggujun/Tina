...
namespace Tina {
    ...
    public:
        ...
        bool equal(const ByteBuffer &other) const {
            ...
            return memcmp(buffer_.data(), other.buffer_.data(), size()) == 0;
        }
        ...
        void copyTo(ByteBuffer &other) const {
            other.resize(size());
            memcpy(other.buffer_.data(), buffer_.data(), size());
            other.rPos_ = rPos_;
            other.wPos_ = wPos_;
        }
