...
M10-A2c–A2f provide cooked load, dependency order, batch load, and bounded
`validateCatalogPackageOnDisk`; Windows MSVC Debug/Release `tina_asset_tests` pass 34/34. Handle/Lease,
async IO, a catalog validation CLI, and Cooker remain out of scope.
