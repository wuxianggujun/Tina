...
M10-A2c–A2q provide the sync catalog/cooked pipeline. M10-A3–A15 add CPU Handle/Lease, AssetSystem
...
`tina_sample_asset`, cooked/manifest wire writers, atomic publish, `tina_assetc` fixture/recipe cooker,
and Texture2D/Sprite payload v1 codecs. CPU TaskGroup pools, real bgfx texture sampling, and full
