...
M10-A2c–A2g provide cooked load, dependency order, batch load, package validate, and
`openCatalogPackage`. Handle/Lease, async IO, a catalog validation CLI, and Cooker remain out of scope.
