...
M10-A2c–A2q provide the sync catalog/cooked pipeline. M10-A3–A14 add CPU Handle/Lease, AssetSystem
...
`writeFile`/`publishCatalogPackage`, and `tina_assetc` fixture/recipe cooker. CPU TaskGroup pools,
