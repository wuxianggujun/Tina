...
M10-A2c–A2q provide the sync catalog/cooked pipeline. M10-A3–A6 add CPU Handle/Lease, AssetSystem
load/request/pump, and bounded IO Task + Main completion for async file reads. CPU TaskGroup pools,
GPU UploadTicket/retirement, and Cooker remain out of scope.
