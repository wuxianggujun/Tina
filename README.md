...
M10-A2c–A2q provide the sync catalog/cooked pipeline. M10-A3–A25 add CPU Handle/Lease, AssetSystem
...
typed2d/recipe cooker. Full formal `tina_sample_2d` (TileMap/Box2D/UI) and full cgltf Cooker remain
out of scope.
