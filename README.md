...
M10-A2c–A2q provide the sync catalog/cooked pipeline. M10-A3–A7 add CPU Handle/Lease, AssetSystem
load/request/pump, bounded IO Task + Main completion, Desktop default BoundedTaskSystem, and a Null
UploadTicket ledger. CPU TaskGroup pools, bgfx upload/ReadyGpu, and Cooker remain out of scope.
