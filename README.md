...
M10-A2c–A2j provide cooked load, dependency order, batch load, package validate,
`openCatalogPackage`, the `tina_catalog_validate` CLI, package summary diagnostics, and
`planCatalogLoads`. Handle/Lease, async IO, and Cooker remain out of scope.
